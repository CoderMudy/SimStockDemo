//
//  EliteChatStockTableVC.m
//  SimuStock
//
//  Created by jhss_wyz on 15/7/29.
...
@implementation EliteChatStockTableAdapter
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
  ...
  cellHeight += [EliteChatStockTableAdapter getTitleAndContentAndImageHeightWithWeibo:item
...
- (UITableViewCell *)tableView:(UITableView *)tableView
  ...
  /// 绑定聊股标题、聊股内容、聊股图片数据
  height += [EliteChatStockTableAdapter bindTittleAndContentAndContentImageAtCell:cell
                                                                     andIndexPath:indexPath
                                                                 andTopViewBottom:height
                                                                     andTableView:tableView
                                                               andHasUserNameView:NO];

  height += [EliteChatStockTableAdapter bindRPContentAndRPComtentImageAtCell:cell
                                                                andIndexPath:indexPath
                                                                andTableView:tableView
                                                            andTopViewBottom:height
                                                          andHasUserNameView:NO];
  ...
  __weak EliteChatStockTableAdapter *weakSelf = self;
  /// 重写取消收藏回调函数，屏蔽默认实现
  ...
  __weak EliteChatStockTableVC *weakTableVC = (EliteChatStockTableVC *)self.baseTableViewController;
  /// 加精回调
...
@implementation EliteChatStockTableVC
...
- (void)requestDataListWithRefreshType:(RefreshType)refreshType
  ...
  [TweetList requestGetEliteListDataWithBarId:dic[@"barID"]
...
- (BaseTableAdapter *)getBaseTableAdaperWithDataList:(DataArray *)dataList {
  if (_tableAdapter == nil) {
    _tableAdapter = [[EliteChatStockTableAdapter alloc] initWithTableViewController:self
    ...
    /// 删除聊股时的回调
    __weak EliteChatStockTableVC *weakSelf = self;
    EliteChatStockTableAdapter *adapter = (EliteChatStockTableAdapter *)_tableAdapter;
