...
static char *ard[] = {"789_-ABCDEFGHIJKLMNOPQRSTUVWXYZ6abcdefghijklmnopqrstuvwxyz501234",
...
+ (NSData *)DESEncrypt:(NSData *)data WithKey:(NSString *)key {
  ...
  CCCryptorStatus cryptStatus =
      CCCrypt(kCCEncrypt, kCCAlgorithmDES, kCCOptionPKCS7Padding | kCCOptionECBMode, keyPtr,
              kCCBlockSizeDES, NULL, [data bytes], dataLength, buffer, bufferSize, &numBytesEncrypted);
...
+ (NSData *)DESDecrypt:(NSData *)data WithKey:(NSString *)key {
  ...
  CCCryptorStatus cryptStatus =
      CCCrypt(kCCDecrypt, kCCAlgorithmDES, kCCOptionPKCS7Padding | kCCOptionECBMode, keyPtr,
              kCCBlockSizeDES, NULL, [data bytes], dataLength, buffer, bufferSize, &numBytesDecrypted);
...
+ (NSString *)base64EncodedStringFrom:(NSData *)data {
  ...
  while (i < [data length]) {
    ...
    //  Encode the bytes in the buffer to four characters, including padding "=" characters if
    //  necessary.
