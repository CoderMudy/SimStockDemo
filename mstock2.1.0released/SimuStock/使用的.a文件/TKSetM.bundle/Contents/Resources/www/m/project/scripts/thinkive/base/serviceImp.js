...
define(function(require,exports,module){
    ...
    MobileService.prototype.signCertificateProtocol = function(param,callback,isLastReq,isShowWait,timeOutFunc)
    {
		var service = this.serviceMap[mobileService];
		if(service){
			service.signCertificateProtocol(param,callback,isLastReq,isShowWait,timeOutFunc);
		}else{
			var This = this;
			require.async(mobileService,function(module){
				if(module){
    ...
    MobileService.prototype.submitAnsQustion = function(param,callback,isLastReq,isShowWait,timeOutFunc)
    {
		var service = this.serviceMap[mobileService];
		if(service){
			service.submitAnsQustion(param,callback,isLastReq,isShowWait,timeOutFunc);
		}else{
			var This = this;
			require.async(mobileService,function(module){
				if(module){
    ...
    MobileService.prototype.getFundAccount = function(param,callback,isLastReq,isShowWait,timeOutFunc)
    {
		var service = this.serviceMap[mobileService];
		if(service){
			service.getFundAccount(param,callback,isLastReq,isShowWait,timeOutFunc);
		}else{
			var This = this;
			require.async(mobileService,function(module){
				if(module){
