	...
	MobileService.prototype.checkSmsCode = function(param,callback,isLastReq,isShowWait,timeOutFunc)
      {
 		...
 		paraMap["recommender_id"] = param.recommender_id;
 		var reqParamVo = $.getReqParamVo();
		reqParamVo.setUrl(global.serverPath);
		reqParamVo.setReqParam(paraMap);
		reqParamVo.setIsLastReq((typeof(isLastReq)=="undefined"||isLastReq==="")?true:isLastReq);
...
//		paraMap["enum_type"] = param.enum_type;
   	 ...
   	 * @param mobile_no 		 手机号码
   	 * @param industry_type      行业代码
   	 * @param recommender_id	 客户经理id
   	 * @param info_qd	 		 创业板转签渠道
   	 * @param namecyb	         创业板转签关系人姓名
   	 * @param mobilecyb	         创业板转签关系人电话
   	 * @param relation	         创业板转签关系
   	 * @param callback           回调函数
   	 */
	MobileService.prototype.submitUserInfo = function(param,callback,isLastReq,isShowWait,timeOutFunc)
    {
		...
		paraMap["mobile_no"] = param.mobile_no;
		paraMap["industry_type"] = param.industry_type;
		paraMap["recommender_id"] = param.recommender_id;
		paraMap["info_qd"] = param.info_qd;
		paraMap["namecyb"] = param.namecyb;
		paraMap["mobilecyb"] = param.mobilecyb;
		paraMap["relation"] = param.relation;
		var reqParamVo = $.getReqParamVo();
		reqParamVo.setUrl(global.serverPath);
		reqParamVo.setReqParam(paraMap);
		reqParamVo.setIsLastReq((typeof(isLastReq)=="undefined"||isLastReq==="")?true:isLastReq);
	...
	MobileService.prototype.queryOpenCheckSign = function(param,callback,isLastReq,isShowWait,timeOutFunc)
    {
		...
		paraMap["mobile_no"] = param.mobile_no;
		paraMap["protcl_type"] = param.protcl_type;
		var reqParamVo = $.getReqParamVo();
		reqParamVo.setUrl(global.serverPath);
		reqParamVo.setReqParam(paraMap);
		reqParamVo.setIsLastReq((typeof(isLastReq)=="undefined"||isLastReq==="")?true:isLastReq);
	...
	MobileService.prototype.submitQQApplay = function(param,callback,isLastReq,isShowWait,timeOutFunc)
    {
		...
		paraMap["week_day"] = param.week_day;
		paraMap["mobile_no"] = param.mobile_no;
		paraMap["client_name"] = param.client_name;
		var reqParamVo = $.getReqParamVo();
		reqParamVo.setUrl(global.serverPath);
		reqParamVo.setReqParam(paraMap);
		reqParamVo.setIsLastReq((typeof(isLastReq)=="undefined"||isLastReq==="")?true:isLastReq);
	...
	MobileService.prototype.submitPhoto = function(param,callback,isLastReq,isShowWait,timeOutFunc)
    {
		...
		paraMap["branchno"] = param.branchno;
		paraMap["commission"] = param.commission;
		paraMap["unit"] = param.unit;
		paraMap["fare_type"] = param.fare_type;
    ...
    /**
   	 ...
   	 * @param callback 回调函数
   	 */
	MobileService.prototype.signCertificateProtocol = function(param,callback,isLastReq,isShowWait,timeOutFunc)
    {
	    var paraMap = {};
		paraMap["funcNo"] = "501997";
		paraMap["user_id"] = param.user_id;
		paraMap["jsondata"] = param.jsondata;
		paraMap["ipaddr"] = param.ipaddr;
		paraMap["macaddr"] = param.macaddr;
    ...
    /**
   	 * 提交问卷回访(501993)
   	 * @param mobile_no 手机号码
   	 * @param revisited_wj 所有题目答案
   	 * @param callback 回调函数
   	 */
	MobileService.prototype.submitAnsQustion = function(param,callback,isLastReq,isShowWait,timeOutFunc)
    {
	    var paraMap = {};
		paraMap["funcNo"] = "501993";
		paraMap["mobile_no"] = param.mobile_no;
		paraMap["revisited_wj"] = param.revisited_wj;
		var reqParamVo = $.getReqParamVo();
		reqParamVo.setUrl(global.serverPath);
		reqParamVo.setReqParam(paraMap);
		reqParamVo.setIsLastReq((typeof(isLastReq)=="undefined"||isLastReq==="")?true:isLastReq);
   	 ...
   	 * @param callback 回调函数
   	 */
	MobileService.prototype.getFundAccount = function(param,callback,isLastReq,isShowWait,timeOutFunc)
    {
	    var paraMap = {};
		paraMap["funcNo"] = "501994";
		paraMap["mobile_no"] = param.mobile_no;
		var reqParamVo = $.getReqParamVo();
		reqParamVo.setUrl(global.serverPath);
		reqParamVo.setReqParam(paraMap);
