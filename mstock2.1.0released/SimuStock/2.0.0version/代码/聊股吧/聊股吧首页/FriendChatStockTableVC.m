...
@implementation FriendChatStockTableAdapter
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
  ...
  cellHeight += [FriendChatStockTableAdapter getTitleAndContentAndImageHeightWithWeibo:item
...
- (UITableViewCell *)tableView:(UITableView *)tableView
  ...
  /// 绑定聊股标题、聊股内容、聊股图片数据
  height += [FriendChatStockTableAdapter bindTittleAndContentAndContentImageAtCell:cell
                                                                      andIndexPath:indexPath
                                                                  andTopViewBottom:height
                                                                      andTableView:tableView
                                                                andHasUserNameView:NO];

  height += [FriendChatStockTableAdapter bindRPContentAndRPComtentImageAtCell:cell
                                                                 andIndexPath:indexPath
                                                                 andTableView:tableView
                                                             andTopViewBottom:height
                                                           andHasUserNameView:NO];
  ...
  __weak FriendChatStockTableAdapter *weakSelf = self;
  /// 重写取消收藏回调函数，屏蔽默认实现
...
@implementation FriendChatStockTableVC
...
- (void)requestDataListWithRefreshType:(RefreshType)refreshType
  ...
  [TweetList requestGetMyFollowListWithFromId:dic[@"fromId"]
...
- (BaseTableAdapter *)getBaseTableAdaperWithDataList:(DataArray *)dataList {
  if (_tableAdapter == nil) {
    _tableAdapter = [[FriendChatStockTableAdapter alloc] initWithTableViewController:self
    ...
    FriendChatStockTableAdapter *adapter = (FriendChatStockTableAdapter *)_tableAdapter;
