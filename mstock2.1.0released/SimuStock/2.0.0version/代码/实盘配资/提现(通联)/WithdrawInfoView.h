...
/** 确认提现按钮 */
@property(weak, nonatomic) IBOutlet UIButton *determineWithdrawBtn;

/** 分割线 */
@property(weak, nonatomic) IBOutlet UIView *marginViewOne;
@property(weak, nonatomic) IBOutlet UIView *marginViewTwo;
@property(weak, nonatomic) IBOutlet UIView *marginViewThree;
@property(weak, nonatomic) IBOutlet UIView *marginViewFour;
@property(weak, nonatomic) IBOutlet UIView *marginViewFive;
